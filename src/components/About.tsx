  ...
  return (
    <section id="about" className="flex flex-col gap-3">
      <div className="flex flex-col gap-5 text-base text-muted-foreground">
        ...
        <p className="">
          Throughout his career, he has mentored a diverse group of high-achieving individuals, including entrepreneurs, researchers, scientists, corporate executives, and industry leaders, who have credited his teachings for significantly enhancing their leadership, decision-making, and spiritual well-being. Some of them are having highly successful careers at Google, Microsoft, NUS Singapore, IITs, BITS, CEERI, DRDO, University of Minnesota, UIUC, Samsung, DShaw, Goldman Sachs, etc.
        </p>
        <p className="">
